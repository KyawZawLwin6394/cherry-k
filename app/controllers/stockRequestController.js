...
exports.listAllStockRequests = async (req, res) => {
    ...
    try {
        ...
        let result = await StockRequest.find(query).sort({ date: -1 }).populate('procedureMedicine.item_id medicineLists.item_id procedureAccessory.item_id relatedBranch relatedTransfer');
